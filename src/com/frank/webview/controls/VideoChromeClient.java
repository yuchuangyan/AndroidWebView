...
public class VideoChromeClient extends WebChromeClient implements OnPreparedListener, OnCompletionListener, OnErrorListener
{
     ...
     */
    public VideoChromeClient(View nonVideoLayout, ViewGroup videoLayout, View loadingView2, VideoWebView webView2, Context mainActivity)
    {
     ...
     * @param webView2 
     */
    public VideoChromeClient(View activityNonVideoView, ViewGroup activityVideoView, View loadingView, WebView webView2)
    {
        this.activityNonVideoView = activityNonVideoView;
        this.activityVideoView = activityVideoView;
        this.loadingView = loadingView;
        this.webView = (VideoWebView) webView2;
        this.isVideoFullscreen = false;
    }
